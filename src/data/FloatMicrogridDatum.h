...
#ifndef RESEARCH_MICROGRID_CPP_FLOATMICROGRIDDATUM_H
#define RESEARCH_MICROGRID_CPP_FLOATMICROGRIDDATUM_H

#include "MicrogridDatum.h"
#include "MicrogridFloatMeasurementType.h"
 ...
 */
class FloatMicrogridDatum : public MicrogridDatum {
private:
    /**
     * measurementType
     *
     ...
     */
    MicrogridFloatMeasurementType measurementType;
...
protected:
    ...
    void setMeasurementType(MicrogridFloatMeasurementType measurementType);
...
public:
     ...
     */
    FloatMicrogridDatum(long timestamp, const MicrogridNode *node,
                        MicrogridFloatMeasurementType measurementType, float value);

    //----Getters----
    MicrogridFloatMeasurementType getMeasurementType() const;
...
#endif //RESEARCH_MICROGRID_CPP_FLOATMICROGRIDDATUM_H
